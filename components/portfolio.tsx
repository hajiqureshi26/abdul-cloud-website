...
export default function Portfolio() {
  ...
  return (
    <main>
        ...
        <div className="hero-content">
          <Reveal>
            ...
            <div className="hero-actions">
              ...
              <a className="button button-ghost" href="/abdul-rahman-qureshi-resume.txt" download><Download size={16} /> Resume</a>
            </div>
      ...
      <section className="section-pad resume-section" id="resume"><Reveal className="resume-banner"><div><div className="eyebrow"><span className="eyebrow-dot" />The short version</div><h2>Let&apos;s build systems<br />people can rely on.</h2><p>Download a concise resume, or start a conversation about cloud, delivery, and reliability work.</p></div><a className="button button-primary" href="/abdul-rahman-qureshi-resume.txt" download><Download size={16} /> Download resume</a></Reveal></section>

      <section className="section-pad contact-section" id="contact"><Reveal><div className="contact-kicker">HAVE A SYSTEM TO SHIP?</div><h2>Let&apos;s talk<br /><span>infrastructure.</span></h2><p>Open to conversations about DevOps, cloud deployment, SRE practice, and early-career opportunities where careful engineering matters.</p><div className="contact-links"><a href="mailto:abdulrahman.qureshi@example.com"><span className="contact-icon">@</span> Email <ArrowUpRight size={15} /></a><a href="https://github.com" target="_blank" rel="noreferrer"><Github size={18} /> GitHub <ArrowUpRight size={15} /></a><a href="https://linkedin.com" target="_blank" rel="noreferrer"><Linkedin size={18} /> LinkedIn <ArrowUpRight size={15} /></a></div></Reveal></section>
